...
export const DOC_SECTIONS: readonly DocSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { id: "reference/providers", title: "Model providers", description: "Provider selection, failover, and spend attribution." },
  ...
  },
  {
    title: "Release",
    links: [
      { id: "release/contributor-workflow", title: "Contributor workflow", description: "Spec-driven delivery with independent review." },
