...
| `ebrain-mcp` | Fallback stdio MCP launcher del motor interno: igual + `MCP_STDIO=1`. El path primario post-FASE D es HTTP via `ebrain up`; esto queda para rollback. |
...
cp scripts/ebrain-run scripts/ebrain-mcp scripts/gbrain-run scripts/gbrain-mcp scripts/ebrain-q scripts/ebrain-brain scripts/ebrain-daemon scripts/ebrain-up ~/.config/ebrain/
chmod 700 ~/.config/ebrain/ebrain-run ~/.config/ebrain/ebrain-mcp ~/.config/ebrain/gbrain-run ~/.config/ebrain/gbrain-mcp ~/.config/ebrain/ebrain-q ~/.config/ebrain/ebrain-brain ~/.config/ebrain/ebrain-daemon ~/.config/ebrain/ebrain-up
