...
const workflowRecordFixture = {
  ...
  schema_version: 1,
  source_path: "/home/dev/notes/workflows/structured-agentic-development/_workflow.md",
  content_hash: "a".repeat(64),
  updated_at: "2026-07-15T00:00:00.000Z",
  steps: ["Load context", "Plan", "Implement", "Verify"],
  gates: ["Verify: bun test ./cli/", "Gate: reviewed by someone other than the author"],
