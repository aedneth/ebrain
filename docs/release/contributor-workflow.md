...
4. Record structural changes in `CHANGELOG.md` and a phase report when applicable.
...
work, require a different checker. A maker report is evidence for review, not self-approval.
