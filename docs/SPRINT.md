...
- [ ] 4.6h2 **Guard merge + contract freeze** — `harness/core/guard-secrets.sh` (dual-output JSON+exit2) reemplaza los dos guards; `harness/contract/events.md` + fixtures → tests en `ebrain doctor` (alarma de drift).
